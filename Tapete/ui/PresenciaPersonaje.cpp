...
// archivo   PresenciaPersonaje.cpp
...
namespace tapete
{
    ...
    void PresenciaPersonaje::preparaPanel(LadoTablero lado_tablero, int indice_grupo)
    {
        ...
        float espacio_total = 3 * 135.0f;
        float y_base = PresenciaTablero::regionPanelVertclIzqrd.posicion().y();
        float y_centro = y_base + (PresenciaTablero::tamanoPanelVertcl.y() - espacio_total) / 2.0f;

        float y = y_centro + 30.0f + indice_grupo * 135.0f;
