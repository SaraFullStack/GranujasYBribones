...
// archivo   ModoJuegoLibreDoble.cpp
...
namespace tapete
{
    ...
    ModoJuegoLibreDoble::ModoJuegoLibreDoble(JuegoMesaBase *juego) : estado_{EstadoJuegoPares::inicial},
    ...
    void ModoJuegoLibreDoble::escribeEstado()
    {
        ...
        case EstadoJuegoLibreDoble::inicioTurnoNoElegido:
            ...
            {
                juego()->tablero()->escribeMonitor(std::vector<string>{"Selecciona un personaje del equipo",
                                                                       "rojo.",
                                                                       "Pulsa un retrato."},
                                                   {});
            }
        ...
        case EstadoJuegoComun::inicioJugada:
            ...
            juego()->tablero()->escribeMonitor(std::vector<string>{juga,
    ...
    void ModoJuegoLibreDoble::validaAtributos()
    {
        ...
        case EstadoJuegoLibreDoble::inicial:
            ...
            break;
        case EstadoJuegoLibreDoble::terminal:
            valida(NULO, NULO, NINGUNO, NULO, ignora, ignora, ignora, CERO, NULO, ignora, NULO, VACIO);
            break;
        case EstadoJuegoLibreDoble::inicioRonda:
            valida(NULO, ASIGNADO, NINGUNO, NULO, ignora, ignora, ignora, CERO, NULO, ignora, NULO, VACIO);
            break;
        case EstadoJuegoLibreDoble::inicioTurnoNoElegido:
            valida(NULO, ASIGNADO, NINGUNO, NULO, ignora, ignora, ignora, CERO, NULO, ignora, NULO, VACIO);
            break;
        ...
        case EstadoJuegoLibreDoble::inicioTurnoConfirmacion:
            valida(NULO, ASIGNADO, UNO, NULO, ignora, ignora, ignora, CERO, NULO, ignora, NULO, VACIO);
            break;
        case EstadoJuegoLibreDoble::inicioJugada:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, SI, NO, NULO, CERO, NULO, ignora, NULO, VACIO);
            break;
        case EstadoJuegoLibreDoble::preparacionDesplazamiento:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, SI, NO, DESPLAZAM, CERO, NULO, ignora, NULO, VACIO);
            break;
        case EstadoJuegoLibreDoble::marcacionCaminoFicha:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, SI, NO, DESPLAZAM, VARIOS, NULO, ignora, NULO, VACIO);
            break;
        case EstadoJuegoLibreDoble::habilidadSimpleInvalida:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, SI, NO, HABILIDAD, CERO, ASIGNADO, SIMPLE, NULO, VACIO);
            break;
        case EstadoJuegoLibreDoble::habilidadSimpleConfirmacion:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, SI, NO, HABILIDAD, CERO, ASIGNADO, SIMPLE, NULO, VACIO);
            break;
        case EstadoJuegoLibreDoble::habilidadSimpleResultado:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, ignora, ignora, HABILIDAD, CERO, ASIGNADO, SIMPLE, NULO, VACIO);
            break;
        case EstadoJuegoLibreDoble::preparacionHabilidadOponente:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, SI, NO, HABILIDAD, CERO, ASIGNADO, OPONENTE, NULO, VACIO);
            break;
        case EstadoJuegoLibreDoble::oponenteHabilidadInvalido:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, SI, NO, HABILIDAD, CERO, ASIGNADO, OPONENTE, ASIGNADO, VACIO);
            break;
        case EstadoJuegoLibreDoble::oponenteHabilidadConfirmacion:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, SI, NO, HABILIDAD, CERO, ASIGNADO, OPONENTE, ASIGNADO, VACIO);
            break;
        case EstadoJuegoLibreDoble::oponenteHabilidadCalculando:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, SI, NO, HABILIDAD, CERO, ASIGNADO, OPONENTE, ASIGNADO, VACIO);
            break;
        case EstadoJuegoLibreDoble::oponenteHabilidadResultado:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, ignora, ignora, HABILIDAD, CERO, ASIGNADO, OPONENTE, ASIGNADO, VACIO);
            break;
        case EstadoJuegoLibreDoble::preparacionHabilidadArea:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, SI, NO, HABILIDAD, CERO, ASIGNADO, AREA, NULO, VACIO);
            break;
        case EstadoJuegoLibreDoble::areaHabilidadInvalida:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, SI, NO, HABILIDAD, CERO, ASIGNADO, AREA, NULO, NO_VACIO);
            break;
        case EstadoJuegoLibreDoble::areaHabilidadConfirmacion:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, SI, NO, HABILIDAD, CERO, ASIGNADO, AREA, NULO, NO_VACIO);
            break;
        case EstadoJuegoLibreDoble::areaHabilidadCalculando:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, SI, NO, HABILIDAD, CERO, ASIGNADO, AREA, NULO, NO_VACIO);
            break;
        case EstadoJuegoLibreDoble::areaHabilidadResultado:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, ignora, ignora, HABILIDAD, CERO, ASIGNADO, AREA, NULO, NO_VACIO);
            break;
        case EstadoJuegoLibreDoble::agotadosPuntosAccion:
            valida(NULO, ASIGNADO, UNO, ASIGNADO, ignora, ignora, NULO, CERO, NULO, ignora, NULO, VACIO);
            break;

        case EstadoJuegoLibreDoble::mostrandoAyuda:
            valida(ignora, ignora, ignora, ignora, ignora, ignora, ignora, ignora, ignora, ignora, ignora, ignora);
            break;
        case EstadoJuegoLibreDoble::finalPartida:
            valida(NULO, NULO, NINGUNO, NULO, ignora, ignora, ignora, CERO, NULO, ignora, NULO, VACIO);
            break;
        }
    }
