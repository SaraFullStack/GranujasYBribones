...
namespace tapete
{
    ...
    ExcepcionConfigura::ExcepcionConfigura(
        const wstring &mensaje, const LocalizaConfigura localiza) : ExcepcionConfigura{mensaje, "", localiza}
    {
    }

    ExcepcionConfigura::ExcepcionConfigura(
        const wstring &mensaje, const string &lo_que,
        const LocalizaConfigura localiza) : std::logic_error{"ExcepcionConfigura"}
    {
    ...
    ExcepcionEstado::ExcepcionEstado(const EstadoJuegoComun &estado) : std::logic_error{"ExcepcionEstado"},
                                                                       estado{estado}
    {
    ...
    ExcepcionValidacion::ExcepcionValidacion(
        const string &modulo, const string &metodo, const string &explicacion) : std::logic_error{"ExcepcionValidacion"}
    {
    ...
    ExcepcionValidacion::ExcepcionValidacion(const string &atributo, const string &condicion) : std::logic_error{"ExcepcionValidacion"},
                                                                                                atributo{atributo},
                                                                                                condicion{condicion}
    {
    ...
    ExcepcionProcesoJuego::ExcepcionProcesoJuego(
        ...
        ModoJuegoComun &modo) : std::logic_error{"ExcepcionProcesoJuego"},
                                clase{clase},
                                metodo{metodo},
